...
const IndexedDB = require('./database/IndexedDB').default.class
const BlockChainInfo = require('./network/BlockChainInfo').default.class
const EsAccount = require('../EsAccount').default.class

const CoinData = function () {
  this._initialized = false
  this._device = D.TEST_JS_WALLET ? require('../device/JsWallet').default.instance : require('../device/CoreWallet').default.instance
