...
const EsWallet = function () {
  if (D.TEST_JS_WALLET) {
    this._device = require('./device/JsWallet').default.instance
  } else {
    this._device = require('./device/CoreWallet').default.instance
  }
  this._coinData = require('./data/CoinData').default.instance
}
