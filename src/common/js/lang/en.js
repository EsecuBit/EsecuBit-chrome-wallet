export const message = {
  ...
  login_prompt_msg: 'Please insert your wallet on your computer and unlock it',
  login_prompt_msg1: 'Please insert your wallet on your computer and unlock it',
  ...
  accounts_form_placeholder: 'Enter your new account name',
  accounts_name: 'Name',
  ...
  send_is_click: 'Please enter your PIN and check the transaction details on your device. Press OK button to confirm.',
  ...
  error_needPressKey: 'The device idles for a long time and goes to sleep.Press the key to wake up.',
  ...
  error_networkValueTooSmall: 'Transaction FEES are too low to trade',
